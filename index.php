...
<head>
    ...
    <style>
        * {
        ...
        /* Баннер */
.banner {
    background-color: #2b4f60; /* Синий цвет фона */
    padding: 50px;
    text-align: center;
...
/* Секция поиска */
.search-section {
    background-color: #f4f4f4; /* Светлый фон для области поиска */
}
...
.search-button {
    padding: 10px 20px;
    background-color: #1e3d58; /* Тот же синий цвет */
    color: white;
    border: none;
    border-radius: 5px;
    cursor: pointer;
...
.search-button:hover {
    background-color: #165072; /* Немного темнее при наведении */
}
...
<body>
    ...
    <script>
        ...
        // Переключение отображения секции регистрации
